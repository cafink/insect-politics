 ...
 */
//$config['dsn'] = "mysqli://mysqlbug:2m6i4s0@localhost/carl_training";
...
$config['timestamp_format'] = 'Y-m-d H:i:s';  // How posts & comments are timestamped in the DB
...
// show_comments controls whether or not existing comments are displayed.
// enable_comments controls whether or not readers may submit new comments.
...
$config['comment_expiration'] = 30 * 24 * 60 * 60; // in seconds
...
// If use_snippets is true, a snippet will be displayed for any post that
// has one (posts that don't have snippets will display in their entirety).
...
// Model.  Also, the snippet should be well-formed, so don't put the marker
// inside any elements.
